...
Matrix	Matrix::lookAt(const Vec3& eye, const Vec3& center, const Vec3& up)
{
	...
	M(0,0) = s._x;	M(1, 0) = s._y;		M(2, 0) = s._z;		M(3, 0) = 0.0f;
	M(0,1) = u._x;	M(1, 1) = u._y;		M(2, 1) = u._z;		M(3, 1) = 0.0f;
	M(0,2) = -f._x;	M(1, 2) = -f._y;	M(2, 2) = -f._z;	M(3, 2) = 0.0f;
